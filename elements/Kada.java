...
public class Kada extends RoomElement{
    public Kada(String ime, Room parent, int sirina, int visina, Point lokacija, int rotacija) {
    ...
    public Prototype clone() {
        return new Kada(this.getIme(),(Room)this.getParent(),(int)(this.getSirina()/ ((Room) this.getParent()).getRatioS()),(int)(this.getVisina()/ ((Room) this.getParent()).getRatioV()),this.getLokacija(),this.getRotacija());
    }
}
